...
| `string_gsub_spec.rb` | String#gsub with pattern and replacement | `core/string/gsub_spec.rb` | 14 | 0 |
...
| `string_sub_spec.rb` | String#sub with pattern, replacement | `core/string/sub_spec.rb` | 13 | 0 |
