# Runtime-aware loader for the sinatra-contrib/LinkHeader fixture.
# Same shape as multi_route_smoke / required_params_smoke /
# sinatra_json_smoke: both runtimes resolve `sinatra/link_header`
# to the same vendored source.

HARNESS_PORT = (ENV["HARNESS_PORT"] || "9301").to_i
