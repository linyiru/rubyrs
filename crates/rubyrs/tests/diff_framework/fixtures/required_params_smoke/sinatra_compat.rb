# Runtime-aware loader for the sinatra-contrib/RequiredParams
# vendoring fixture. Identical shape to multi_route_smoke /
# sinatra_cors_smoke / sinatra_param_smoke: both runtimes
# resolve `sinatra/required_params` to the same vendored source.

HARNESS_PORT = (ENV["HARNESS_PORT"] || "9299").to_i
