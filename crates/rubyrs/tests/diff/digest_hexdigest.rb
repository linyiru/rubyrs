# Native SHA-256 / SHA-1 / MD5 via Digest::SHA2 / SHA256 / SHA1 / MD5,
# byte-exact with CRuby's digest C extension. Class shortcut + the
# incremental new/update/hexdigest surface.
require "digest"
