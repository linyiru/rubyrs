...
impl Vm {
    ...
    pub(crate) fn responds_to(&self, recv: &Value, name_id: SymId) -> bool {
        ...
        match recv {
            ...
            Value::BoundMethod(_) => matches!(name, "call" | "[]" | "()" | "unbind" | "bind_call" | "arity" | "parameters" | "==" | "!=" | "eql?" | ">>" | "<<" | "curry" | "to_proc" | "owner" | "receiver" | "name" | "hash" | "source_location"),
            Value::UnboundMethod(_) => matches!(name, "bind" | "bind_call" | "arity" | "parameters" | "==" | "!=" | "eql?" | "owner" | "name" | "hash" | "source_location"),
