# rubyrs-spec-extract v0.3: 6 pattern(s) left for hand polish.
...
#
#   - L5: `before` — only `before :each` is lifted in v0.3
#   - L9: `after` — not lifted; inline cleanup or skip the block
#   - L13: `context` — micro-runner treats as describe; if you use `before :all` here it won't lift
#   - L15: `it_behaves_like` — shared-example inlining is v0.4
